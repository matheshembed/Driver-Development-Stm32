...
DRIVERS/SRC/%.o DRIVERS/SRC/%.su DRIVERS/SRC/%.cyclo: ../DRIVERS/SRC/%.c DRIVERS/SRC/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DSTM32 -DSTM32F4 -DSTM32F446RETx -DNUCLEO_F446RE -c -I../Inc -I"D:/Driver-Development-Stm32/STM32F4XX_DRIVERS/DRIVERS/INC" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
